...
######### VPN Connection Logs
output "vpn_connection_logs_group_arn" {
  value       = module.vpn_connection_logs.log_group_arn
  description = "ARN of the log group"
}

output "vpn_connection_logs_group_name" {
  value       = module.vpn_connection_logs.log_group_name
  description = "Name of log group"
}

output "vpn_connection_logs_arn" {
  value       = module.vpn_connection_logs.role_arn
  description = "ARN of role to assume"
}

output "vpn_connection_logs_role_name" {
  value       = module.vpn_connection_logs.role_name
  description = "Name of role to assume"
}
###VPC Endpoint
