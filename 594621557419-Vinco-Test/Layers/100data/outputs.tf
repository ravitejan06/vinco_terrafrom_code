...
#### RDS SG
output "aurouz_test_db_sg_id" {
  description = "RDS Security Group ID."
  value       = aws_security_group.aurouz_test_db_sg.id
}

output "aurouz_test_db_sg_name" {
  description = "RDS Security Group Name."
  value       = aws_security_group.aurouz_test_db_sg.name
}
...
##### Redis SG
output "aurouz_test_cache_sg_id" {
  description = "Redis Cache Security Group ID."
  value       = aws_security_group.aurouz_test_cache_sg.id
}

output "aurouz_test_cache_sg_name" {
  description = "Redis Cache Security Group Name."
  value       = aws_security_group.aurouz_test_cache_sg.name
}
...
output "redis_endpoint_record" {
  ...
  description = "For Redis Cluster mode enabled"
}
